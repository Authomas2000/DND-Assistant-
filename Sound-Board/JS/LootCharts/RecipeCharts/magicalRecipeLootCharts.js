...
let magicalRecipesArray = [
    //Common (%60 chance to draw one of these items)
    { name: "magical gem recipes", minRarity: 1, maxRarity: 50, minQty: 1, maxQty: 1, rarity: 3 },
    //{ name: "magical handle recipes", minRarity: 30, maxRarity: 50, minQty: 1, maxQty: 1, rarity: 3 },
    //Uncommon (%20 chance to draw one of these items)
    { name: "magical tool recipes", minRarity: 50, maxRarity: 60, minQty: 1, maxQty: 1, rarity: 3 },
    { name: "magical armament recipes", minRarity: 60, maxRarity: 70, minQty: 1, maxQty: 1, rarity: 3 },
    { name: "magical lure recipes", minRarity: 70, maxRarity: 80, minQty: 1, maxQty: 1, rarity: 3 },
    //Rare (%20 chance to draw one of these items)
    { name: "weapon enchantment recipes", minRarity: 80, maxRarity: 90, minQty: 1, maxQty: 1, rarity: 3 },
    { name: "armor enchantment recipes", minRarity: 90, maxRarity: 100, minQty: 1, maxQty: 1, rarity: 3 },
]

//soul magic recipes Chart (100) (incomplete) (ready to use)
let soulMagicRecipesArray = [
    //Common (%60 chance to draw one of these items)
    { name: "magical gem recipes", minRarity: 1, maxRarity: 50, minQty: 1, maxQty: 1, rarity: 3 },
    { name: "magical handle recipes", minRarity: 50, maxRarity: 100, minQty: 1, maxQty: 1, rarity: 3 },
]

//lost magic recipes Chart (100) (incomplete) (ready to use)
let lostMagicRecipesArray = [
    //Common (%60 chance to draw one of these items)
    { name: "magical sentry recipes", minRarity: 1, maxRarity: 30, minQty: 1, maxQty: 1, rarity: 3 },
    { name: "magical lure recipes", minRarity: 30, maxRarity: 60, minQty: 1, maxQty: 1, rarity: 3 },
    { name: "magical tool recipes", minRarity: 60, maxRarity: 100, minQty: 1, maxQty: 1, rarity: 3 },
]
...
let magicalGemsRecipesArray = [
    ...
    { name: "Soul Gem Recipe", minRarity: 1, maxRarity: 30, minQty: 1, maxQty: 1, rarity: 3 },
    { name: "Quickness Gem (LVL1) Recipe", minRarity: 30, maxRarity: 55, minQty: 1, maxQty: 1, rarity: 3 },
    { name: "Reenchant Gem (LVL1) Recipe", minRarity: 55, maxRarity: 80, minQty: 1, maxQty: 1, rarity: 3 },
    //uncommon (%20 chance to draw one of these items)
