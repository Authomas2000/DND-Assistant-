...
let sorcererPouchArray = [
    ...
    { name: "coins", minRarity: 1, maxRarity: 25, minQty: 1, maxQty: 3, rarity: 3 },
    //{ name: "plants", minRarity: 25, maxRarity: 70, minQty: 2, maxQty: 1, rarity: 3   },
    { name: "gems", minRarity: 70, maxRarity: 90, minQty: 1, maxQty: 2, rarity: 3 },
    //{ name: "potions", minRarity: 90, maxRarity: 100, minQty: 2, maxQty: 1, rarity: 3   },
    //Uncommon (%0 chance to draw one of these items)
    //Rare (%0 chance to draw one of these items)
]
